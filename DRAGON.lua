...
keyboard = {
{'━┅┅┄⟞⟦ مطورين السورس ⟧⟝┄┉┉━'},
{'المالك تايجر𖠜','مبرمج السورس𖠜'},
{'قناة السورس𖠜','بوت التواصل𖠜'},
{'خلفيات رومانسيه𖠜','صور كرتون𖠜'},
{'غنيلي𖠜 فديو𖠜','فديو اجنبي𖠜'},
{'افلام اجنبي𖠜','افلام عربي𖠜'},
{'كرتون يوغي𖠜'},
{'تويت𖠜','صراحه𖠜'},
{'استوري𖠜','باد𖠜'},
{'انصحنى','كتابات𖠜','نكته𖠜'},
{'ضحكني𖠜','ثيم𖠜'},
{'صورتي𖠜','لو خيروك𖠜'},
{'يوتيوب𖠜','قصيده𖠜'},
{'التاريخ𖠜','الساعه𖠜'},
...
if text == 'يوتيوب𖠜' or text == 'بحث' or text == 'اليوتيوب𖠜' then
local Text = [[
اليك بوتات تحميل 🍂
من جميع المواقع 🍂
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت اليوتيوب𖠜 ♥️',url="t.me/Youtubee0bot"}},
...
if text == 'احمد' or text == 'احمد المصري' or text == 'مبرمج السورس𖠜' then
local Text = [[
...
if text == 'تايجر' or text == 'رامي' or text == 'المالك تايجر𖠜' then
local Text = [[
مالك سورس افلاين
]]
keyboard = {} 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت اليوتيوب𖠜 🇲🇦',url="t.me/Qeaa_bot"}},
...
if text == "كتابات𖠜" or text == "حكمه" or text == "قصيده𖠜" then 
local TWEET_Msg = { 
...
if text == "انصحني𖠜" or text == "انصحنى" or text == "انصح" then 
local TWEET_Msg = { 
...
if text == "باد𖠜" or text == "اسئله محرجه" then 
local TWEET_Msg = { 
" لا تحقرون صغيره إن الجبال من الحصي🥵",
...
if text == "نكته𖠜" or text == "نكته" or text == "ضحكني𖠜" then 
local TWEET_Msg = { 
...
send(msg.chat_id_, msg.id_, " ☫ لا تسطيع حظر مبرمج السورس𖠜 عام")
return false 
end
...
send(msg.chat_id_, msg.id_, " ☫ لا يمكنك حظر مبرمج السورس𖠜 \n")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1751768178) then  
send(msg.chat_id_, msg.id_, " ☫ لا تسطيع كتم مبرمج السورس𖠜 عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1717439120) then  
send(msg.chat_id_, msg.id_, " ☫ لا تسطيع كتم مبرمج السورس𖠜 عام")
...
if result.id_ == tonumber(1751768178) then
send(msg.chat_id_, msg.id_, " ☫ لا يمكنك كتم مبرمج السورس𖠜 \n")
return false 
end
if result.id_ == tonumber(1717439120) then
send(msg.chat_id_, msg.id_, " ☫ لا يمكنك كتم مبرمج السورس𖠜 \n")
...
if text == "تفعيل صورتي𖠜" or text == 'تفعيل الصوره' then
if Constructor(msg) then  
...
if text == "تعطيل الصوره" or text == 'تعطيل صورتي𖠜' then
if Constructor(msg) then  
...
if text == "غنيلي𖠜" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
...
if text == "تويت𖠜" then  
ght = math.random(1,33);  
local Text ='مرحبا إليك تويت𖠜 بالصوره'  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '  ❨𝐚𝐡𝐦𝐞𝐝 𝐚𝐥𝐦𝐬𝐫𝐲❩ ', url="t.me/DEV_AH8"}},
{{text = '❨ اضف البوت لمجموعتك ❩', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
...
if text == "استوري𖠜" then  
ght = math.random(1,33);  
local Text ='تم اختيار استوري𖠜'  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '  ❨𝐚𝐡𝐦𝐞𝐝 𝐚𝐥𝐦𝐬𝐫𝐲❩ ', url="t.me/DEV_AH8"}},
{{text = '❨ اضف البوت لمجموعتك ❩', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
...
if text == "كرتون يوغي𖠜" then  
ght = math.random(1,33);  
local Text ='اليك حلقه من كرتون يوغي𖠜'  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '  ❨𝐚𝐡𝐦𝐞𝐝 𝐚𝐥𝐦𝐬𝐫𝐲❩ ', url="t.me/DEV_AH8"}},
{{text = '❨ اضف البوت لمجموعتك ❩', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
...
if text == "الساعه𖠜" then
local ramsesj20 = "\n الساعه𖠜 الان : "..os.date("%I:%M%p")
send(msg.chat_id_, msg.id_,ramsesj20)
end

if text == "التاريخ𖠜" then
local ramsesj20 =  "\n التاريخ𖠜 : "..os.date("%Y/%m/%d")
send(msg.chat_id_, msg.id_,ramsesj20)
end
--------------
...
if text == 'انا مين𖠜' and SudoBot(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/Dahab_source)') 
return false
end


if text == 'انا مين𖠜' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/Dahab_source)') 
return false
end

if text == 'انا مين𖠜' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/Dahab_source)') 
return false
end

if text == 'انا مين𖠜' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/Dahab_source)') 
return false
end

if text == 'انا مين𖠜' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/Dahab_source)') 
return false
end

if text == 'انا مين𖠜' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/Dahab_source)') 
return false
end

if text == 'انا مين𖠜' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/Dahab_source)') 
return false
end

if text == 'انا مين𖠜' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/Dahab_source)') 
return false
end

if text == 'انا مين𖠜' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌝❤️ ](t.me/Dahab_source)') 
return false
end

if text == 'انا مين𖠜' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/Dahab_source)') 
return false
end
...
local Fun = {'لوكي وزاحف من ساع زحفلي وحضرته 😒','خوش ولد و ورده مال الله 💋🙄','يلعب ع البنات 🙄', 'ولد زايعته الكاع 😶🙊','صاك يخبل ومعضل ','محلو وشواربه جنها مكناسه 😂🤷🏼‍♀️','اموت عليه 🌝','هوه غير ا��حب مال اني 🤓❤️','مو خوش ولد صراحه𖠜 ☹️','ادبسز وميحترم البنات  ', 'فد واحد قذر 🙄😒','ماطيقه كل ما اكمشه ريحته جنها بخاخ بف باف مال حشرات 😂🤷‍♀️','مو خوش ولد 🤓' } 
...
if text == "صراحه𖠜" or text == "الصراحه𖠜" and msg.reply_to_message_id_ ~= 0 and Addictive(msg) then
...
local LEADER_Msg = {
"صراحه𖠜  |  صوتك حلوة؟",
"صراحه𖠜  |  التقيت الناس مع وجوهين؟",
"صراحه𖠜  |  شيء وكنت تحقق اللسان؟",
"صراحه𖠜  |  أنا شخص ضعيف عندما؟",
"صراحه𖠜  |  هل ترغب في إظهار حبك ومرفق لشخص أو رؤية هذا الضعف؟",
"صراحه𖠜  |  يدل على أن الكذب مرات تكون ضرورية شي؟",
"صراحه𖠜  |  أشعر بالوحدة على الرغم من أنني تحيط بك كثيرا؟",
"صراحه𖠜  |  كيفية الكشف عن من يكمن عليك؟",
"صراحه𖠜  |  إذا حاول شخص ما أن يكرهه أن يقترب منك ويهتم بك تعطيه فرصة؟",
"صراحه𖠜  |  أشجع شيء حلو في حياتك؟",
"صراحه𖠜  |  طريقة جيدة يقنع حتى لو كانت الفكرة خاطئة توافق؟",
"صراحه𖠜  |  كيف تتصرف مع من يسيئون فهمك ويأخذ على ذهنه ثم ينتظر أن يرفض؟",
"صراحه𖠜  |  التغيير العادي عندما يكون الشخص الذي يحبه؟",
"صراحه𖠜  |  المواقف الصعبة تضعف لك ولا ترفع؟",
"صراحه𖠜  |  نظرة و يفسد الصداقة؟",
"صراحه𖠜  |  ‏‏إذا أحد قالك كلام سيء بالغالب وش تكون ردة فعلك؟",
"صراحه𖠜  |  شخص معك بالحلوه والمُره؟",
"صراحه𖠜  |  ‏هل تحب إظهار حبك وتعلقك بالشخص أم ترى ذلك ضعف؟",
"صراحه𖠜  |  تأخذ بكلام اللي ينصحك ولا تسوي اللي تبي؟",
"صراحه𖠜  |  وش تتمنى الناس تعرف عليك؟",
"صراحه𖠜  |  ابيع المجرة عشان؟",
"صراحه𖠜  |  أحيانا احس ان الناس ، كمل؟",
"صراحه𖠜  |  مع مين ودك تنام اليوم؟",
"صراحه𖠜  |  صدفة العمر الحلوة هي اني؟",
"صراحه𖠜  |  الكُره العظيم دايم يجي بعد حُب قوي تتفق؟",
"صراحه𖠜  |  صفة تحبها في نفسك؟",
"صراحه𖠜  |  ‏الفقر فقر العقول ليس الجيوب  ، تتفق؟",
"صراحه𖠜  |  تصلي صلواتك الخمس كلها؟",
"صراحه𖠜  |  ‏تجامل أحد على راحتك؟",
"صراحه𖠜  |  اشجع شيء سويتة بحياتك؟",
"صراحه𖠜  |  وش ناوي تسوي اليوم؟",
"صراحه𖠜  |  وش شعورك لما تشوف المطر؟",
"صراحه𖠜  |  غيرتك هاديه ولا تسوي مشاكل؟",
"صراحه𖠜  |  ما اكثر شي ندمن عليه؟",
"صراحه𖠜  |  اي الدول تتمنى ان تزورها؟",
"صراحه𖠜  |  متى اخر مره بكيت؟",
"صراحه𖠜  |  تقيم حظك ؟ من عشره؟",
"صراحه𖠜  |  هل تعتقد ان حظك سيئ؟",
"صراحه𖠜  |  شـخــص تتمنــي الإنتقــام منـــه؟",
"صراحه𖠜  |  كلمة تود سماعها كل يوم؟",
"صراحه𖠜  |  **هل تُتقن عملك أم تشعر بالممل؟",
"صراحه𖠜  |  هل قمت بانتحال أحد الشخصيات لتكذب على من حولك؟",
"صراحه𖠜  |  متى آخر مرة قمت بعمل مُشكلة كبيرة وتسببت في خسائر؟",
"صراحه𖠜  |  ما هو اسوأ خبر سمعته بحياتك؟",
"‏صراحه𖠜  | هل جرحت شخص تحبه من قبل ؟",
"صراحه𖠜  |  ما هي العادة التي تُحب أن تبتعد عنها؟",
"‏صراحه𖠜  | هل تحب عائلتك ام تكرههم؟",
"‏صراحه𖠜  |  من هو الشخص الذي يأتي في قلبك بعد الله – سبحانه وتعالى- ورسوله الكريم – صلى الله عليه وسلم؟",
"‏صراحه𖠜  |  هل خجلت من نفسك من قبل؟",
"‏صراحه𖠜  |  ما هو ا الحلم  الذي لم تستطيع ان تحققه؟",
"‏صراحه𖠜  |  ما هو الشخص الذي تحلم به كل ليلة؟",
"‏صراحه𖠜  |  هل تعرضت إلى موقف مُحرج جعلك تكره صاحبهُ؟",
"‏صراحه𖠜  |  هل قمت بالبكاء أمام من تُحب؟",
"‏صراحه𖠜  |  ماذا تختار حبيبك أم صديقك؟",
"‏صراحه𖠜  | هل حياتك سعيدة أم حزينة؟",
"صراحه𖠜  |  ما هي أجمل سنة عشتها بحياتك؟",
"‏صراحه𖠜  |  ما هو عمرك الحقيقي؟",
"‏صراحه𖠜  |  ما اكثر شي ندمن عليه؟",
"صراحه𖠜  |  ما هي أمنياتك المُستقبلية؟‏",
"صراحه𖠜  | هل قبلت فتاه؟"
}
...
if text and text ~="صراحه𖠜" and database:get(bot_id..":"..msg.sender_user_id_..":rkko_Bots"..msg.chat_id_) == "sendrkkoe" then
