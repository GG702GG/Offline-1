...
{'•━═━═━═『ᴏғғʟɪɴᴇ』═━═━═━•'},
{'اغاني فديو عربي','اغاني فديو اجنبي'},
{'كرتون يوغي'},
{'•━═━═━═『ᴏғғʟɪɴᴇ』═━═━═━•'},
{'تويت','صراحه'},
{'استوري','باد'},
...
if text == "اغاني فديو عربي" then  
ght = math.random(1,33);  
local Text ='يتم اختيار فيو قامد شبهك'  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '  ❨𝐚𝐡𝐦𝐞𝐝 𝐚𝐥𝐦𝐬𝐫𝐲❩ ', url="t.me/DEV_AH8"}},
{{text = '❨ اضف البوت لمجموعتك ❩', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&https://t.me/a7a_10/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text and text:match("^قول (.*)$") then
local Textxt = text:match("^قول (.*)$")
send(msg.chat_id_, msg.id_, '['..Textxt..']')
