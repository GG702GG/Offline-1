...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Dahab_source/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'بوت تواصل' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/TWASOL_ᴏғғʟɪɴᴇBOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل السورس 📬', url="t.me/TWASOL_ᴏғғʟɪɴᴇBOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت اليوتيوب 💌',url="t.me/Enginner_mido3bot"}},
{{text = 'بوت تيك توك 💌',url="t.me/K0XBOT"}},
{{text = 'بوت انستا 💌',url="t.me/J33Bot"}},
{{text = 'بوت قرأن 💌',url="t.me/quran_lbot"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 ᴏғғʟɪɴᴇ',url="t.me/Dahab_source"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Dahab_source/13&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Dahab_source/25&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/Dahab_source)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/Dahab_source)') 
return false
end

if text == 'باي' or text == 'بيي' then
send(msg.chat_id_,msg.id_, '[ع فين لوين رايح وسايبنى🙁💔](t.me/Dahab_source)') 
return false
end

if text == 'طيب' or text == 'تيب' then
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب😹💋💃🏻](t.me/Dahab_source)') 
return false
end

if text == 'يستا' or text == 'يسطا' then
send(msg.chat_id_,msg.id_, '[قابلتك ع البسطه 😂❤](t.me/Dahab_source)') 
return false
end

if text == 'وه' or text == 'وهه' then
send(msg.chat_id_,msg.id_, '[بسيفلاح يعره مسمعش صوتكك😹🤸🏻‍♀🙊](t.me/Dahab_source)') 
return false
end

if text == 'اي' or text == 'ايي' then
send(msg.chat_id_,msg.id_, '[جتك اوهه م سامع ولا ايي😹👻](t.me/Dahab_source)') 
return false
end

if text == 'نعم' or text == 'نعام' then
send(msg.chat_id_,msg.id_, '[نعم الله عليك🙂](t.me/Dahab_source)') 
return false
end

if text == 'هه' or text == 'ههه' then
send(msg.chat_id_,msg.id_, '[ضحكه مش سالكه 😳😂](t.me/Dahab_source)') 
return false
end

if text == 'بتحبنيي' or text == 'بتحبني' then
send(msg.chat_id_,msg.id_, '[وهو القمر ميتحبش ؟؟ ❤️😂](t.me/Dahab_source)') 
return false
end

if text == '🙂' or text == '🙂💔' then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😘❤️](t.me/Dahab_source)') 
return false
end

if text == 'طاسه' then
send(msg.chat_id_,msg.id_, '[امك حلوة وابوك ورقاصة😂💃🏻](t.me/Dahab_source)')
return false
end

if text == 'حبكك' or text == 'حبك' then
send(msg.chat_id_,msg.id_, '[حبككك اكترر ❤️](t.me/Dahab_source)') 
return false
end

if text == 'اخرس' or text == 'اخرص' then
send(msg.chat_id_,msg.id_, '[هتت لازقه وحطها ع بوئيي😹🙊🤸🏻‍♀](t.me/Dahab_source)') 
return false
end

if text == 'حبيبيي' or text == 'حبيبي' then
send(msg.chat_id_,msg.id_, '[اوه ياه 🌝😂](t.me/Dahab_source)') 
return false
end

if text == 'حبيبتيي' or text == 'حبيبتي' then
send(msg.chat_id_,msg.id_, '[اوعه ع الجمدان بقا حبيبتي وشغل عالي 🙈❤️](t.me/Dahab_source)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ياحلولي هي فاكراني انسان ولا اي😹❤️](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عادي يتفلق هنعملو اي..😒💔](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بنهش كتاكيت احنا هنا ولا اى😒💔](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وتسبني لمين طيب..🥺💔](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خلصتت روحكك يبعيد😹🚶🏻‍♀💔](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يقطعني 😹🙆🏻‍♀♥️](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[انت الخير ياعمري..❤️](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اعدل وشكك ونت بتكلمني 😒](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ضحكتك عثل زيكك ينوحيي 🌝❤️](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[حصلخير اي هيجي منين الخير وانت هنا. 🙂😂](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[حصل حصوله 😹💜](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لاء متقولش نينينينني😹🏃🏻‍♀♥️](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[انا اجمد ..👽💕](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجع تاني م حوارر 😹🚶🏻‍♀♥️](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌝♥️](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[القمر ده شبهك..🙂♥️](t.me/Dahab_source)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/Dahab_source)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بعشقك يا روحي💋🥰](t.me/Dahab_source)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌝](t.me/Dahab_source)') 
return false
end
end
end
