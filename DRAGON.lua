...
sudo_users = {SUDO,1751768178,1675072350,1970207619,1614314857,1743756832}   
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Dahab_source/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = '𝐒𝐨𝐮𝐫𝐜𝐞 𝐎𝐟𝐟𝐥𝐢𝐧', url="t.me/Dahab_source"}},
}
local msg_id = msg.id_/2097152/0.5 
