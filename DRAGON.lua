...
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,"رتبتك"..Rutba(msg.sender_user_id_,msg.chat_id_).."نين عيني🙈❤️", msg.id_, msg.id_, "md")
else
